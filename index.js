...
// nestedFunction can access the variable internal because of closure, nestedFunction is an inner function that is reaching out of its scope to the variable defined in the outer function.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    let totalPop = array.reduce(function(pv, cv){
